      ...
      <div className="relative z-10">
        ...
        <section className="max-w-6xl mx-auto px-4 py-20 border-t border-white/5 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mb-20">
            ...
            <a href="https://www.linkedin.com/in/avindu-oshan/" target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-black/50 backdrop-blur-md text-white border border-gray-600 font-bold rounded-full hover:border-white transition-colors duration-300 w-full sm:w-auto">
              LinkedIn
            </a>
